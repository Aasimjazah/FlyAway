...
<form style="margin-top:5%; border:2px solid black;" class="form-inline" action="#">
  ...
  <label for="text"> Check by Email:</label>
...
if(search!=null)
{
  ...
  %>
	...
	<%
      ...
      List <Pessenger> p =   AddPessengerDetailsBusinessLogic.getAllPessengers();
      ...
      for(Pessenger pes: p)
      {
    	  ...
    	  {
    		  List<Flight> f = AddFlightBusinessLogic.getAllFlights();
